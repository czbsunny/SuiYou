...
@Component
public class MoneyFundStrategy implements AssetStrategy {
    ...
    public Asset createAsset(AssetCreateRequest request) {
        ...
        asset.setGroupType("INVESTMENT");
        asset.setCategory("MONEY_FUND");
        asset.setSubCategory(request.getSubCategory() != null ? request.getSubCategory() : "CASH_EQUIVALENT");
