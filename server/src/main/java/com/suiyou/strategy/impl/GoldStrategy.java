...
@Component
public class GoldStrategy implements AssetStrategy {
    ...
    public Asset createAsset(AssetCreateRequest request) {
        ...
        asset.setCategory("GOLD");
        asset.setSubCategory(request.getSubCategory() != null ? request.getSubCategory() : "PHYSICAL");
