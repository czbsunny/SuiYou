...
@Component
public class MedicalInsuranceStrategy implements AssetStrategy {
    ...
    public Asset createAsset(AssetCreateRequest request) {
        ...
        asset.setCategory("MEDICAL_INSURANCE");
        asset.setSubCategory(request.getSubCategory() != null ? request.getSubCategory() : "PERSONAL");
        ...
        asset.setAvailableBalance(asset.getTotalBalance());
        return asset;
    }
