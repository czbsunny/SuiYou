...
public class DefaultAssetStrategy implements AssetStrategy {
    ...
    public Asset createAsset(AssetCreateRequest request) {
        ...
        asset.setGroupType(request.getGroupType());
        ...
        asset.setValuationMode(request.getValuationMode() != null ? request.getValuationMode() : "MANUAL");
    ...
    public Asset updateBasicInfo(Asset asset, AssetUpdateRequest request) {
        ...
        if (request.getValuationMode() != null) {
            asset.setValuationMode(request.getValuationMode());
        }
